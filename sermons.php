...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjNs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
...
<div layout-wrap layout="row">
	<div class="header-image">
		<img src="/app/img/Asset 6@3x.png" width="100%">
	</div>

<div layout-wrap layout="row" flex ng-repeat="sermon in sermons | groupBy: year">
    <div layout="column">
      <md-card class="md-button cr-sermons" style="background-color: #F6AF20; color: black; text-align: center">
          <md-card-title>
              \\\sermon.year\\\
          </md-card-title>
      </md-card>
